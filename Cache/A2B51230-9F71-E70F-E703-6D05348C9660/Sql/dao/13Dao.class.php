...
require_once BASE_PATH."Sql/example/13Example.class.php";
class 13Dao extends SqlDaoInterface{
    private $conn;
    private $tableName = "13";
    /**
    ...
    public function selectByExample($POJOExample){
        if($POJOExample instanceof 13Example){
            $this->getConn();
            $values = "";
