...
require_once BASE_PATH."Sql/example/1234Example.class.php";
class 1234Dao extends SqlDaoInterface{
    private $conn;
    private $tableName = "1234";
    /**
    ...
    public function selectByExample($POJOExample){
        if($POJOExample instanceof 1234Example){
            $this->getConn();
            $values = "";
