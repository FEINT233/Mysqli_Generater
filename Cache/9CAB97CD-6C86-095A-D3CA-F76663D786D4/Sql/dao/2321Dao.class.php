...
require_once BASE_PATH."Sql/example/2321Example.class.php";
class 2321Dao extends SqlDaoInterface{
    private $conn;
    private $tableName = "2321";
    /**
    ...
    public function selectByExample($POJOExample){
        if($POJOExample instanceof 2321Example){
            $this->getConn();
            $values = "";
